...
class ContentStorage:
    ...
    def _init_database(self):
        ...
        try:
            ...
            self.logger.info(
                f"MongoDB database initialized: {self.database_name}")
    ...
    def has_content_hash(self, content_hash: str) -> bool:
        ...
        try:
            count = self.pages_collection.count_documents(
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            successful_pages = self.pages_collection.count_documents(
                {'status_code': 200})
            failed_pages = self.pages_collection.count_documents(
                {'status_code': {'$ne': 200}})
